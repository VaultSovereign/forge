  ...
  paths: {
    ...
    '/v1/api/health': {
      get: {
        summary: 'API health',
        responses: {
          200: { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { ok: { type: 'boolean' }, ts: { type: 'string' }, version: { type: 'string' } }, required: ['ok'] } } } }
        }
      }
    },
    '/v1/api/health/deep': {
      get: {
        ...
        responses: {
          200: { description: 'Probe result', content: { 'application/json': { schema: { type: 'object' } } } }
        }
      }
    },
    '/v1/api/templates': {
      get: {
        ...
        responses: {
          200: { description: 'List', content: { 'application/json': { schema: { $ref: '#/components/schemas/TemplateArray' } } } },
    ...
    '/v1/api/templates/count': {
      get: {
        ...
        responses: {
          200: { description: 'Count', content: { 'application/json': { schema: { $ref: '#/components/schemas/TemplateCount' } } } }
        }
      }
    },
    '/v1/api/ledger/events': {
      get: {
        ...
        responses: {
          200: { description: 'Events', content: { 'application/json': { schema: { $ref: '#/components/schemas/LedgerRows' } } } }
        }
      }
    },
    '/v1/api/execute': {
    ...
    '/v1/api/execute/stream': {
      get: {
        ...
        parameters: [
          ...
          { name: 'args', in: 'query', schema: { type: 'string', description: 'JSON-encoded args' } }
        ],
        responses: {
    ...
    '/guardian/ask': {
      post: {
        ...
        responses: {
          200: { description: 'Response', content: { 'application/json': { schema: { $ref: '#/components/schemas/GuardianAskResponse' } } } }
        }
      }
    },
    '/v1/guardian/mode': {
      get: {
        ...
        responses: {
          200: { description: 'Mode', content: { 'application/json': { schema: { type: 'object', properties: { mode: { type: 'string', enum: ['stub', 'agent', 'unknown'] }, ts: { type: 'number' } }, required: ['mode'] } } } }
        }
      }
    }
  }
