...
async function main() {
  ...
  const lines = [];
  lines.push('<!-- ⚠️ AUTO-GENERATED: do not edit. See scripts/generate-docs-sitemap.mjs -->');
  lines.push('');
  ...
  lines.push(
    '  <a href="INDEX.md" style="display:inline-block; padding:8px 12px; background:#6f42c1; color:#fff; border-radius:6px; text-decoration:none; font-weight:600;">👉 Curated Docs Index</a>',
  );
  lines.push('</div>');
  lines.push('');
  lines.push(
    `_Auto-generated by \`scripts/generate-docs-sitemap.mjs\`. Generated on ${new Date().toISOString()}._`,
  );
  lines.push('');
