...
import { useStreamingHeartbeat } from '../hooks/useStreamingHeartbeat.js';
const STATUS_META = {
    connecting: {
        label: 'Connecting',
        bg: '#fef3c7',
...
export default function StreamingBadge() {
    ...
    return (_jsxs("span", { title: `Streaming status: ${meta.label}. ${meta.description}`, style: {
            display: 'inline-flex',
            alignItems: 'center',
            gap: 6,
            fontSize: 12,
            ...
            border: `1px solid ${meta.fg}20`
                ...
                } }), _jsxs("span", { children: ["Streaming: ", meta.label] })] }));
}
